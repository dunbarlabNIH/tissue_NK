...
plot_labels_T <- paste( paste(metadata_df[sample_index, ]$Timepoint, "m", sep = ""), metadata_df[sample_index, ]$Experiment, metadata_df[sample_index, ]$Cell.Type)
...
p_all <- ggplot(all_data_pca_df,aes(x=PC1,y=PC2, shape = timepoints, color = location)) + 
  ...
  scale_shape_manual(values = c("45.5" = 16, "46" = 17, "47" = 15, "48" = 8, "49" = 18, "49.5" = 7)) + 
